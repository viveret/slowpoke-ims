...
public partial class Config
{
    ...
    public class PathsConfig
    {
        ...
        [Default(".slowpoke")]
        public string PrivateFilesFolderName { get; set; } = ".slowpoke";
        ...
        public string DocId2PathFolderName { get; set; } = "doc-ids-2-paths";
        
        [JsonIgnore, IgnoreDataMember]
        public string DocId2PathPath => Path.Combine(PrivateFilesPath, DocId2PathFolderName);
        
        [Default("doc-paths-2-ids")]
        public string DocPaths2IdsFolderName { get; set; } = "doc-paths-2-ids";
